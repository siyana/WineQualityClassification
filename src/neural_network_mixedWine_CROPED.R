...
inputTest = columnsTest[,1:7]
outputTest = decodeClassLabels(columnsTest$quality)

mixedWineTrainResultsPath = paste(basePath,"//results//NN//mixed_whiteWine_matrix_train_CROPPED.csv", sep = "")
whiteTestResultsPath =  paste(basePath,"//results//NN//mixed_whiteWine_matrix_test_CROPPED.csv", sep = "")
